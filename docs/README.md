...
This directory contains the comprehensive documentation for the Cloud-Native Modernization Reference Framework (CNMRF). The documentation is structured to provide architectural guidance, implementation patterns, and governance standards for adopting cloud-native systems.
